...
class Game():
    ...
    def getInitBoard(self):
        ...
        """
        self.board = Board(self.n, self.coordinates)
    ...
    def getNextState(self, board, player, action):
        ...
        return np.array(nextBoard), nextPlayer
    ...
    def getValidMoves(self, board, player):
        ...
        return self.board.get_valid_moves(board, player)

    def getGameEnded(self, board, player, round):
        """
        Input:
            board: current board
            player: current player (1 or -1)
